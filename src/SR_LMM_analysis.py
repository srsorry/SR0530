...
def generate_lmm_report(df_results, best_dist_beta, best_dist_score):
    ...
    md.append("## 三、可视化\n\n")
    md.append("![LMM 综合分析](FIG/SR0530_LMM_Results.png)\n\n")
    md.append("![Q-Q 残差图](FIG/SR0530_LMM_QQPlots.png)\n\n")
    ...
    md_path = os.path.join(BASE_DIR, 'report', 'SR0530_Task1_LMM_Report.md')
